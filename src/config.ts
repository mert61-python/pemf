...
export const DOWNLOAD_HOST = {
  ...
  androidVersion: '2.3.11',
  get androidAsset(): string {
    return `PEMF_Vet_Mobil-${this.androidVersion}.apk`
  },
  androidReady: true, // Android standalone APK yayinda (v2.3.11 / versionCode 18)
}
