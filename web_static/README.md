...
- **Yerine geçen:** React arayüz — [`../apps/ui/`](../apps/ui/README.md) → [`../frontend/dist`](../frontend/README.md).
- Silinmeden referans olarak bırakıldı; runtime'ı etkilemez.

---
İlgili: [proje geneli](../README.md) · [güncel arayüz: apps/ui/](../apps/ui/README.md)
