...
def export_csv(
    ...
    try:
        # DENETIM P3: session_ids SQL'e HIC girmiyordu → birkac seans istense bile 10.000 satir
        # 11 LEFT JOIN ile belleğe cekilip Python'da filtreleniyordu. Filtre artik SQL'de.
