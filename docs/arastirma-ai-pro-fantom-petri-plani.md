...
| 6 ✅ | Fantom/petri fiziksel yerleşim ve koordinat çerçevesi | **KESİN (2026-09-09):** fantom ve petri kabinde **YATAY**, doğrudan tabanın üzerinde (0-2 cm); marker düz + kenarları paralel yapıştırılacak; fantom eğitim verisi sabit konumdan. **Kod uygulandı** (`7abf6a4`): hedef düzlemi yapılandırılabilir + marker→kabin rotasyonu. ⚠️ **Ölçüm bu kararın mevcut KAMERA konumuyla çalışmadığını gösterdi** (kamera taban hizasında → sığ açı → gerçek fotoğrafta kuyu kabin DIŞINDA). **Sahip: şimdilik dokunulmuyor, tezgâhta ölçülecek** → yaml eski davranışta (AI Hub analizi bozulmuyor), sürüş bayrak arkasında. Seçenekler: `KABIN_KURULUM_KILAVUZU.md` §0.5 |
