...
2. **main.c TEK dosyadır** — kanonik: `Core/Src/main.c` (BU proje). Eski kök kopya
   ...
   **Tek istisna (2026-09-08): `../stm32_pemf_unipolar/`** — aynı `Core/`nin bayt-bayt AYNASI,
   ...
   başı TEK pin darbelenir; hangi bacak `PEMF_UNIPOLAR_B_BACAK_MASKESI` ile — 0x01 = bobin 1
   PD12/IN_B, bobin 2-5 IN_A; sahip kararı 2026-09-08). O projede main.c'ye DOKUNULMAZ; burada değişince
