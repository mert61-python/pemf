#!/bin/bash
# run_kedi.sh — Auto-restart wrapper for training.py
# Eger Python cokerse otomatik yeniden baslatir.
# Model-level skip sayesinde tamamlanan modeller atlanir.
#
# Usage:
#   nohup bash /home/user02/dr/training/run_kedi.sh >> /home/user02/dr/all_training.log 2>&1 &
#
# Stop:
#   pkill -f "run_kedi.sh"
#   pkill -f "training.py"
...
SCRIPT_DIR="/home/user02/dr/training/em_kedi"
...
echo ""
echo "================================================================================"
echo "[$(date '+%F %T')] run_kedi.sh basladi | PID=$$"
echo "================================================================================"
