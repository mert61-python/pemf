#!/bin/bash
# run_petri_dish.sh — YOLO Petri Dish Training + Analysis
#
# Usage:
#   nohup bash /home/user02/dr/training/run_petri_dish.sh >> /home/user02/dr/petri_dish_training.log 2>&1 &

set -u

SCRIPT_DIR="/home/user02/dr/training/petri_dish"
...
LOG="${WORK_DIR}/petri_dish_training.log"
MAX_RETRIES=10
RETRY_DELAY=15
...
echo ""
echo "================================================================================"
echo "[$(date '+%F %T')] run_petri_dish.sh basladi | PID=$$"
echo "================================================================================"
