#!/usr/bin/env python3
"""
training_petri_dish.py — YOLO Petri Dish Detection Benchmark
================================================================
9 YOLO models: v8, v11, v26 (nano, small, medium)
Dataset: petri_dish (879 train, 83 val, 42 test)
Task: Object Detection (1 class: Petri)

Output: /home/user02/dr/models/models_petri_dish/
"""
...
# CONFIG
# ============================================================
DATASET_YAML = "/home/user02/dr/dataset/petri_dish/data.yaml"
MODELS_DIR = "/home/user02/dr/models/models_petri_dish"
RESULTS_CSV = os.path.join(MODELS_DIR, "model_petri_dish_karsilastirma.csv")
DEVICE = 0  # GPU 0
SEED = 42
IMGSZ = 640
WORKERS = 4
...
if os.path.exists(best_pt):
    ...
    inf_dir = "/home/user02/dr/inference/inference_petri_dish"
