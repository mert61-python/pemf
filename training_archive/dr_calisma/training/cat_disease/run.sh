#!/bin/bash
# run_cat_disease.sh — Auto-restart wrapper for training.py
# Eger Python cokerse otomatik yeniden baslatir.
# Model-level skip sayesinde tamamlanan modeller atlanir.
#
# Usage:
#   nohup bash /home/user02/dr/training/run_cat_disease.sh >> /home/user02/dr/cat_disease_training.log 2>&1 &
#
# Stop:
#   pkill -f "run_cat_disease.sh"
#   pkill -f "training.py"

set -u

SCRIPT_DIR="/home/user02/dr/training/cat_disease"
...
LOG="${WORK_DIR}/cat_disease_training.log"
MAX_RETRIES=50
RETRY_DELAY=15
...
echo ""
echo "================================================================================"
echo "[$(date '+%F %T')] run_cat_disease.sh basladi | PID=$$"
echo "================================================================================"
...
echo "[$(date '+%F %T')] TUM SUREC TAMAMLANDI (egitim + analiz)"
