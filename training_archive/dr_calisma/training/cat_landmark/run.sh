#!/bin/bash
# run.sh — YOLO Cat Landmark Training + Analysis
#
# Usage:
#   nohup bash /home/user02/dr/training/cat_landmark/run.sh >> /home/user02/dr/cat_landmark_training.log 2>&1 &

set -u

SCRIPT_DIR="/home/user02/dr/training/cat_landmark"
...
echo ""
echo "================================================================================"
echo "[$(date '+%F %T')] cat_landmark run.sh basladi | PID=$$"
echo "================================================================================"
