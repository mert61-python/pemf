...
def generate_manual():
    ...
    <body>
        ...
        <div class="toc">
            ...
            <div class="toc-item"><strong>3.</strong> İlk Kurulum (5 Dakikada)</div>
            <div class="toc-item"><strong>4.</strong> Tedavi Başlatma (Adım Adım)</div>
            <div class="toc-item"><strong>5.</strong> Akıllı AI Tedavisi</div>
            <div class="toc-item"><strong>6.</strong> Klinik Protokoller</div>
            <div class="toc-item"><strong>7.</strong> Sık Sorulan Sorular</div>
            <div class="toc-item"><strong>8.</strong> Güvenlik Bilgileri</div>
        </div>
...
(non-invaziv)</li>
        ...
        <div class="step-box">
            ...
            <ul>
                ...
                <li><strong>Birleşik Kontrol:</strong> Tedavi başlatma ekranı</li>
                <li><strong>Seans Geçmişi:</strong> Eski tedavileri görüntüle</li>
            </ul>
        </div>

        <h2>3. İlk Kurulum (5 Dakikada)</h2>
        ...
        <h2>4. Tedavi Başlatma (Adım Adım)</h2>
        ...
        <div class="step-box">
            ...
            <ul>
                <li>🟢 Yeşil = Hazır</li>
                <li>🔴 Kırmızı = Bobin bağlı değil (Bölüm 3'e dönün)</li>
            </ul>
        </div>
