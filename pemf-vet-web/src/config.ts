...
export const PATCH = {
  ...
  notes: [
    'Seans devri artik onceki seansin son dakikasini yeni seansin kaydina yazmiyor — olcumler dogru seansta kaliyor.',
    'Uygulanan doz kaydi (hangi bobin, hangi ayarla, ne kadar) 90 gunde silinmiyor; silinmesi denetim izine yaziliyor.',
    'Ayarlarda kayit yapinca gonderilmeyen alanlar silinmiyor — klinik adi artik kaybolmuyor.',
    'Telefon cihazi daha hizli buluyor: kesif artik gercek portu duyuruyor, ag yayini kendini toparliyor.',
    'Yarim kalan guncelleme dogru geri aliniyor; kurulum iptali arka plandaki indirmeyi silmiyor.',
    '“Cikis” yalniz o cihazi kapatiyor — telefondaki oturumunuz dusmuyor.',
  ],
} as const
