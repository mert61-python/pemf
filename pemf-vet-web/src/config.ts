...
export const DOWNLOAD_HOST = {
  ...
  windowsTag: 'launcher-v1.9.50', // 1.9.50 = 'PROFILLERI DEGISTIR' ARTIK KALDIRIYOR: isareti kaldirilan kurulu profil eskiden hicbir sey yapmiyordu (model dosyalari diskte kaliyor, profil acilis ekraninda gorunmeye devam ediyordu); artik kart 'kaldirilacak' rozeti alir ve yalniz o profile ozel model dosyalari + indirilen paketi silinir (ortak dosyalara ve hasta verisine dokunulmaz). Dugme toplami yalniz gercekten inecekleri sayar; seans surerken kaldirma reddedilir, once bobinler durdurulur. 1.9.49 = PROFIL SECIMINDE 'ANA UYGULAMA' KARTI: ana uygulama (arayuz + ortak modeller) her kurulumda kuruluyordu ama ekranda gorunmuyor, yalniz dugme toplamina sessizce ekleniyordu; artik en ustte onceden secili ve kaldirilamaz bir kart olarak gorunur, gercek boyutunu (~1,5 GB) yazar, kuruluysa 'kurulu' der; profil kartlarinda yalniz kendi boyutlari. 1.9.48 = YARDIMCI YOLLAR ARTIK KANIT BIRAKIYOR (sessiz-yol denetimi): guncelleme yardimcisi ozel karakterli Windows kullanici adinda (& ^) da calisiyor (eskiden o makinede guncelleme ve kaldirma sessizce olu kaliyordu); yedek klasoru secici PowerShell kisitliyken hatayi soyluyor; guncelleme penceresi acilamazsa sebebi gunluge yaziliyor; kaldirmada bobin acil-durdurma sonucu kalici dosyaya yazilip etkilesimli kaldirmada uyariliyor (eskiden sonuc atiliyor, basarisiz E-stop basarili gorunuyordu). 1.9.47 kurulu cihazlar kendiliginden gecer. 1.9.47 = OTOMATIK GUNCELLEME ARTIK GERCEKTEN KURUYOR: 1.9.45 ve 1.9.46'da guncelleme yardimcisi hic calismiyordu — 'Baslatici guncelleniyor...' penceresi acilip bir sure bekliyor, sonra kapaniyor ama uygulama geri acilmiyor ve surum degismiyordu; elle acinca ayni guncelleme bastan iniyordu. Sebep: yardimci komut dosyasi konsolsuz baslatildigi icin ilk boru karakterli satirda oluyordu ve o satir yardimcinin ilk calisan satiriydi, yani kurulum hic baslamiyordu (kurulumun kendisi saglamdi: elle calistirildiginda 27 saniyede kuruluyor). Yardimci artik borusuz calisiyor ve ne yaptigini bir gunluk dosyasina yaziyor. ⚠️ 1.9.45/1.9.46 kurulu cihazlar bu surume KENDILIGINDEN GECEMEZ (onlardaki yardimci hala eski koddur); bu kurulum dosyasi BIR KEZ ELLE calistirilmalidir — hasta kayitlari, profiller ve indirilmis modeller etkilenmez, sonrasinda otomatik guncelleme yeniden calisir. 1.9.46 = KUCUK VE YUKSEK-DPI EKRANLARDA PENCERE DUZGUN: 1366x768 @%150 DPI'da pencere ekrandan tasiyor ve asgari yukseklik yuzunden kucultulemiyordu; 700x540'lik asgari pencerede giris/profil/hata ekranlarinin basligi ust seridin altinda kaliyor ve kaydirmayla da ulasilamiyordu (dikey ortalama tasan icerigi iki uctan kirpiyor). Ust serit etiketleri artik gorunuyor (olu bir medya sorgusu onlari her pencerede gizliyordu), profil kartlari klavyeyle secilebiliyor, modallar Escape ile kapaniyor ve acikken arka plan klavyeden erisilemiyor. 1.9.45 = GUNCELLEME SIRASINDA EKRAN BOS KALMIYOR: oto-guncellemede pencere kapanip yeni surum acilana kadar ekranda hicbir sey gorunmuyordu, kullanici bu bosluk sirasinda uygulamayi yeniden acmaya calisiyordu (Windows Defender'in 265 MB kurulum dosyasini taramasi yavas makinede 10-30 sn surebiliyor); artik 'Baslatici guncelleniyor… PEMF Vet birazdan kendiliginden acilacak' penceresi acilir ve yeni surum acilinca kendini kapatir; bosluk sirasinda tekrar acilan eski surum sessizce cikar (kurulumu bozmaz), basarisiz kurulumda kilit 2 dk icinde kendiliginden cozulur; uygulama zaten aciksa ikinci pencere acilmaz (1.9.44'ten 1.9.45'e gecis eski kodla uygulandigindan o tek seferde bosluk yine gorulur). 1.9.44 = GUNCELLEME SONRASI "BENI HATIRLA" ARTIK DUSMUYOR: oto-guncelleme sonrasi uygulamayi kapatip acinca hesaptan cikilmis oluyor, e-posta+sifre yeniden isteniyordu; asil neden uygulama tarafinda (uygulama 1.9.40: pencere, launcher ile ayni oturum jetonunun eski bir kopyasini tutup yeniliyordu) duzeltildi; launcher ayrica guncelleme cikisinda son oturumu diske isler ve bellekteki oturumu tazeler (1.9.43'ten 1.9.44'e gecis eski kodla uygulandigindan o tek seferde bir kez daha giris istenebilir, sonrasinda korunur). 1.9.43 = BOS/OFFLINE CIHAZDA WEBVIEW2 KURULUMU DUZELTILDI: bos (yeni) bir cihaza kurulumda "Installing WebView2..." adiminda sonsuza kadar takiliyordu — WebView2 calisma zamani Microsoft'tan internet uzerinden indirilmeye calisiliyor, klinik cihazinda internet yok/kisitli olunca timeout olmadan donuyordu; artik WebView2 kurulum dosyasinin ICINE gomuldu, internetsiz de kuruluyor (kurulum dosyasi bu nedenle daha buyuk). 1.9.42 = ANLASILIR AG HATASI: internet ya da DNS kesintisinde ekranda ham teknik metin yerine ne yapmaniz gerektigini soyleyen bir cumle cikiyor (teknik ayrinti destek icin altta korunuyor); anlik bir DNS hatasi artik kurulumu tamamen dusurmuyor, gecici sayilip yeniden deneniyor. Ayrica kaldirma daha temiz: programa ait guvenlik duvari kurallari ve yerel uygulama verisi de siliniyor (kendi onayladiginiz Windows kurallarina dokunulmaz). 1.9.41 = ACIL DUZELTME: 1.9.40 kurulan cihazlar 'Ortam algilaniyor...' ekraninda kaliyordu (arayuz kodu bir bicimlendirme hatasi yuzunden hic calismiyordu). 1.9.40 kurulu cihazlar kendiliginden duzelemez; bu kurulum dosyasi ELLE calistirilmalidir (hasta kayitlari ve profiller etkilenmez). 1.9.40 = ARKA PLAN INDIRMESI DURDURULABILIYOR: yeni surum inerken kartin altinda 'Duraklat' ve 'Iptal' dugmeleri var. Duraklat inen kismi KORUR ('Devam et' kaldigi yerden surer, bastan inmez); Iptal siler ve once onay sorar. Duraklattiginiz indirme, 6 saatte bir kosan otomatik kontrol tarafindan kendiliginden yeniden baslatilmaz. Kendi bastiginiz dugme artik 'indirme tamamlanamadi' hatasi gibi gosterilmiyor. 1.9.39 = COKLU-MODEL-ZIP: launcher bir profilin modellerini birden cok pakette kurabiliyor; boylece 2 GB uzeri buyuk AI agirliklari (bobrek histopatoloji + yara-kapanma modelleri) klinik makinelere inebiliyor. Ayrica indirme kartinda anlik hiza gore KALAN SURE gosterimi. 1.9.38 = BENI HATIRLA + GUNCELLEME SAGLAMLIGI (3. tur denetimi): uygulama kapanirken (guncelleme/pencere) en son oturum jetonu diske islenir ve oturum deposu yazimi ATOMIK yapildi (yarim yazim eski kaydi bozmaz) -> gereksiz "yeniden giris" istekleri elendi; bozuk bir yayinin her acilista yeniden kurulup geri alindigi dongu kiricisi uretimde etkin; calisan backend'i sahiplenen yolda oturum rotasyonu artik baslar; kaldirma/onarimda bobinler her zaman once guvene alinir. 1.9.37 = BENI HATIRLA DUZELTILDI: tedavi penceresi oturum anahtarini tazeledikce yeni oturum client'a geri bildirilir ve diske islenir; oncesinde diskteki kopya eskiyor ve sonraki acilista e-posta+sifre yeniden soruluyordu (ozellikle guncelleme sonrasi). 1.9.36 = BOZUK YAYIN SESSIZCE ONAYLANMIYOR: guncelleme onaylanmadan once tibbi kayit veritabaninin hazir oldugu ayrica dogrulanir; hazir degilse eski surume donulur (cihaz 'acildi' demek 'seans acabiliyor' demek degildi). 1.9.35 = GUNCELLEME ALTYAPISI DENETIMI: kesintiden sonra toparlanma (yarim kalan guncelleme diski kilitlemiyor, uygulama katmani kesintisi kurtariliyor), iki pencere birbirinin kurulumunu bozamiyor, tek disk hatasi GB'larca bosuna indirme baslatmiyor, geri alma artik 'donuldu' derken gercekten donuyor, cevrimdisi acilan makine de guncelleme kontrolu yapiyor, bozuk bir yayin sonsuz dongude yeniden denenmiyor. 1.9.32 = BAKIM/DOGRULAMA: guncelleme akisi uctan uca canli teste tabi tutuldu (istemci sessiz self-update + Android uygulama-ici guncelleme); islevsel degisiklik yok. 1.9.30 = BASLAT DUGMESI guncelleme kontrolu bitmeden cikmiyor (kontrol surerken 'Guncelleme kontrol ediliyor...' yazip bekliyor; tiklama bosa gitmiyor). Ekran DONMUYOR: kurulu cihazda Hazir! aninda cizilir, bekleyen yalniz dugme; internet yoksa dugme hemen acilir. 1.9.29 = GUNCELLEME GORUNURLUGU: arka plan indirmesinde yuzde+bar; SUREKLI ACIK cihazlar da guncelleme aliyor (6 saatte bir kontrol; onceden yalniz acilista bakiliyordu, gunlerce kapatilmayan klinik makinesi yeni surumu HIC gormuyordu -> zorunlu guvenlik guncellemesi de ulasamiyordu); indirme oncesi DISK kontrolu + eski paket temizligi; iki pencere ayni anda guncelleme yapamaz. Suren seans ASLA kesilmez: periyodik tur yalniz indirir+bildirir, kurulum kapat-ac aninda. 1.9.28 = KALDIR -> YENIDEN KUR temiz: Ayarlar > Uygulamalar'dan kaldirmada MQTT broker'i sahipsiz kalip 1883'u tutuyordu -> yeniden kurulumda broker baslamiyor, 6-8 numarali bobinler ULASILAMAZ oluyordu (1-5 seri porttan calistigi icin cihaz calisiyor gibi gorunuyordu). Kaldirma artik broker+tunel yardimcisini adlariyla durduruyor. 1.9.27 = KARARSIZ BAGLANTIDA yanlis "internet yok" (manifest cekimi tek denemeydi; anlik TCP sifirlamasi kurulumu 3'te 1 engelliyordu) -> 3 deneme + kalici hatalarda tekrar yok. 1.9.25 = DENETIM MASASI BOYUTU gercegi yansitiyor (NSIS kurulum aninda ~11 MB yaziyordu; runtime+profiller sonra iniyor). 1.9.24 = GUVENLIK DUVARI UYARISI yanlis alarm vermiyor: Windows'un KENDI izni de sayiliyor; 'kural yok' acilista SUSAR (yalniz Baslat'tan sonra uyarir), acik Block kuralinda her zaman uyarir. 1.9.23 = YARIM KALMIS KURULUM artik 'Hazir!' gorunmuyor (butunluk exe VARLIGI yerine YAPISAL kontrolle olculuyor). 1.9.22 = KESINTI/ESZAMANLILIK: guncelleme ortasinda kapanma artik 'kurulu degil' demiyor (yarim takas acilista kurtarilir); ayni anda iki client kurulum yapamaz; bozuk indirmede tek-seferlik temiz yeniden-deneme. 1.9.21 = SIYAH KONSOL PENCERESI duzeltildi: yardimci komutlar (guvenlik duvari denetimi + kurulum ACL) pencereli launcher'dan calisirken Windows onlara yeni konsol aciyordu; kapat-ac akisinda 2 pencere goruluyordu. 1.9.20 = SAHA ARIZASI: kurulum sonrasi cihaz acilmiyordu (at-rest anahtar uyusmazliginda karantina + veri-gocu sonsuz dongusu + launcher yanlis gunluk yolu + baglanti sizintisi). Ayrica URETICI KIMLIGI duzeltildi: UAC/Yayimci artik IBIA Teknoloji Ltd. Sti. 1.9.19 = PROFIL BAGIMLILIGI KAYNAGINDAN KALKTI: AI Pro organ lokalizasyonu modelleri (inference_cat_organ, ~209 MB) yalniz home.zip'te idi → cekirdege (base-deps) alindi; profiller arasi artik NE zorunlu NE islevsel bag var, home.zip 528→318 MB. 1.9.18 = PROFILLER BAGIMSIZ: 'Veteriner' secilince 'Ev Sahibi' artik ZORLA eklenmiyor (yalniz Vet+Arastirma kurulabilir). 1.9.17 = GIRIS EKRANI: parola goster/gizle + hatali giriste alan temizlenir + gorunmez karakter/bosluk uyarisi (dogru parola 'hatali' deniyordu, alan silinip tekrar yazilinca geciyordu). 1.9.16 = URETIME-HAZIRLIK DENETIMI (Tier 0-3): geri cagirma (min_supported_version), kurulum oncesi disk-alani kontrolu + olu onbellek temizligi, guvenlik-duvari kurali, filo envanteri (surum alanlari heartbeat'te), surum dosyasi app katmaninda (siradan yayinda artik tazelenir). 1.9.13 = KATMANLI GUNCELLEME: paket app(~71MB)+deps(~1,19GB) olarak ayrildi → siradan surum 1,3 GB yerine ~71 MB iner. 1.9.12 = UYGULAMA OTO-GUNCELLEME: client acilista base.zip + model paketlerini de manifest sha'siyla karsilastirip yeniler ("Onar" gerekmez; seans sirasinda ertelenir). 1.9.11 = arayuz metinlerinde "tedavi" -> "seans" (client + kurulum + guncelleme uyarilari). 1.9.9 = client GIRISI (Supabase + Beni hatirla) + oturum devri (uygulamada cift login yok) + cevrimdisi acilis kilidi fix + header tasmasi fix. 1.9.8 = yarım-kalan çoklu-kurulumda tamamlanan profil korunur (iptal→Hazır!) + 1.9.7 Başlat ayrı-pencere (client açık kalır) + 1.9.6 uninstall (os error 5) fix → kayıtlı NSIS uninstaller'ı başlatır. 1.9.5 = KRİTİK backend-deadlock fix (stdout→NUL) + 1.9.4 self-update/uninstaller-fix. Windows-only → mac/linux 1.9.2'de. // Windows'a AYRI etiket: 1.9.4 = self-update + uninstaller-fix (işaretsiz kaldırmada profiller korunur). Windows-only → mac/linux 1.9.2'de kalır (404 olmasın).
  ...
  androidVersion: '2.3.33', // 2026-09-08: manuel kontrolde frekans/duty sinirsiz; ESP cihaz onayi; AI hata mesajlari eylem soyler
...
export const CLIENT = {
  ...
  sizeMB: 3, // NSIS launcher setup ~2.9 MB (asıl uygulama+modeller client içinden iner). ⚠️ Windows 1.9.43'ten beri ~252 MB (WebView2 offline installer gömülü); mac/linux hâlâ küçük. Kart tek sizeMB gösteriyor — Windows'a özel boyut ayrı iş.
  releaseDate: '6 Eyl 2026',
